...
const String defaultShellWallpaperAsset =
    'assets/wallpapers/trails-h-accent-9-dark.png';
...
class WallpaperResource {
  ...
  static const WallpaperResource defaultWallpaper = WallpaperResource.asset(
  ...
  static WallpaperResource? fromPersistenceValue(String value) {
    if (value.startsWith('asset:')) {
      ...
      return WallpaperResource.asset(path);
    }
...
class WallpaperAssignment {
  ...
  WallpaperAssignment withDarkness(WallpaperTarget target, double darkness) {
    final safeDarkness = darkness.isFinite
        ? darkness.clamp(0.0, 1.0).toDouble()
        : 0.0;
    final outputName = target.outputName;
    if (outputName == null) {
      return WallpaperAssignment(
