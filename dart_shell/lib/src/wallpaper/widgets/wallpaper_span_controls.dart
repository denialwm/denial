...
class WallpaperSpanAlignmentSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      container: true,
      label: 'Spanning wallpaper alignment',
      child: Wrap(
          ...
          _AlignmentGroup(
            children: [
              ...
              _ShellIconControl(
                ...
                semanticsLabel: 'Center spanning wallpaper horizontally',
                selected:
              ...
              _ShellIconControl(
                ...
                semanticsLabel: 'Align spanning wallpaper right',
                selected:
          ...
          _AlignmentGroup(
            children: [
              _ShellIconControl(
                ...
                semanticsLabel: 'Align spanning wallpaper top',
...
class WallpaperSelectorCloseButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _ShellIconControl(
      ...
      semanticsLabel: 'Close wallpaper selector',
      selected: false,
      dimension: 46,
      iconSize: 24,
      onPressed: onPressed,
