  ...
  List<ShellThermalReading> get thermalReadings {
    return [
      if (thermalCpuDeciC != null)
        ShellThermalReading(label: 'CPU', deciC: thermalCpuDeciC!),
      if (thermalSvoocDeciC != null)
        ShellThermalReading(label: 'SVOOC', deciC: thermalSvoocDeciC!),
      if (thermalPmicDeciC != null)
        ShellThermalReading(label: 'PMIC', deciC: thermalPmicDeciC!),
      if (thermalExp2DeciC != null)
        ShellThermalReading(label: 'EXP2', deciC: thermalExp2DeciC!),
    ];
  }
