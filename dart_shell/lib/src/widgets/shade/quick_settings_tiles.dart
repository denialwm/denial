              ...
              children: [
                SizedBox(
                  ...
                  child: QuickTile(
                    ...
                    title: 'Performance',
                    subtitle: _profileLabel(profile),
                ...
                SizedBox(
                  ...
                  child: QuickTile(
                    ...
                    title: 'Silent',
                    subtitle: dndReady ? (dnd ? 'On' : 'Normal') : 'Loading',
                    active: dnd,
                    enabled: dndReady,
                    onTap: onToggleDnd,
                    wide: true,
              ...
              children: [
                SizedBox(
                  ...
                  child: QuickTile(
                    ...
                    title: 'Rotation',
                    subtitle: rotationLock ? 'Locked' : 'Automatic',
                    active: !rotationLock,
                ...
                SizedBox(
                  ...
                  child: QuickTile(
                    ...
                    title: 'Keyboard',
                    subtitle: keyboardOpening ? 'Opening…' : 'Open on-screen',
                    active: false,
    ...
    return Row(
      children: [
        ...
        if (widget.onDetails != null) ...[
          ...
          _TileDetailsButton(
            label: 'Open ${widget.title} details',
            foreground: foreground,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const Spacer(),
        const _RoundButton(
          label: 'Settings are not available yet',
          icon: Icons.settings_rounded,
        ),
        const SizedBox(width: 12),
        _RoundButton(
          label: 'Open power and session controls',
