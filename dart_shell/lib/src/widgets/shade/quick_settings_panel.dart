...
import 'status_bar.dart' show formatHm;
    ...
    return ListView(
      ...
      children: [
        QuickSettingsTiles(
          ...
          bluetoothSubtitle: bluetoothStatusLabel(bluetooth),
    ...
    return Row(
      ...
      children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(formatHm(now), softWrap: false, style: ShellText.shadeClock),
            const SizedBox(height: 7),
            Text(
              '${_weekday(now.weekday)} ${now.day}',
              softWrap: false,
