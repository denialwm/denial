...
class _OskKeySpec {
  ...
  String labelText({required bool shiftEnabled, required bool ctrlArmed}) {
  ...
  String semanticLabel({required bool shiftEnabled}) {
    return switch (control) {
      _OskControl.shift => 'Shift',
      _OskControl.symbols => 'Numbers and symbols',
      _OskControl.extraSymbols => 'More symbols',
      _OskControl.letters => 'Letters',
      _OskControl.space => 'Space',
      _OskControl.backspace => 'Backspace',
      _OskControl.enter => 'Enter',
      _OskControl.arrowUp => 'Up',
      _OskControl.arrowDown => 'Down',
      null => labelText(shiftEnabled: shiftEnabled, ctrlArmed: false),
    };
  }
...
const _letterRows = [
  ...
  _OskRowData([
    _OskKeySpec.control(_OskControl.symbols, label: '?123', flex: 17),
...
const _numberRows = [
  ...
  _OskRowData([
    _OskKeySpec.control(_OskControl.extraSymbols, label: '=<', flex: 15),
    _OskKeySpec.text('*'),
    _OskKeySpec.text('"'),
    _OskKeySpec.text("'"),
    _OskKeySpec.text(':'),
  ...
  _OskRowData([
    _OskKeySpec.control(_OskControl.letters, label: 'ABC', flex: 17),
    _OskKeySpec.control(
      _OskControl.arrowUp,
      icon: Icons.keyboard_arrow_up_rounded,
      flex: 10,
