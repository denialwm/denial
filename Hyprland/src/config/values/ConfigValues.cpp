...
#define MS makeConfigValue
    ...
    return std::vector<SP<IValue>>{
        ...
        MS<Bool>("denial:respect_client_decoration_requests", "whether client decoration hints may suppress Denial's frame on normal windows; popup surfaces remain undecorated",
                 false),
