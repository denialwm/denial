...
ActionResult Actions::releaseCursor() {
    // Pointer constraints are compositor-owned Wayland state. Releasing them
    // here keeps the escape path synchronous and independent from Flutter or
