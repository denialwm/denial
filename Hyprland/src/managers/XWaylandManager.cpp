...
void CHyprXWaylandManager::checkBorders(PHLWINDOW pWindow) {
    ...
    bool doesntWantBorders = !pWindow->m_xwaylandSurface->m_motifWantsDecorations;
    ...
    if (pWindow->m_X11DoesntWantBorders == doesntWantBorders)
        return;

    pWindow->m_X11DoesntWantBorders = doesntWantBorders;
    if (const auto SURFACE = pWindow->wlSurface())
