...
void CTrackpadGestures::cancelActiveGesture() {
    // Dropping an active gesture is intentionally different from end(): end
    // may dispatch commands or commit destructive window operations.
