...
namespace Render {
    ...
    class IHyprRenderer {
      public:
        ...
        bool                                beginExternalRender(PHLMONITOR pMonitor, CRegion& damage);
        SP<IFramebuffer>                    externalRenderFramebuffer() const;
        virtual uint32_t                    externalRenderFramebufferId();
        void                                endExternalRender(const std::function<void()>& renderingDoneCallback = {});
