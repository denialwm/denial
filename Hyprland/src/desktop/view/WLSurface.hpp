...
namespace Desktop::View {
    ...
    class CWLSurface {
      public:
        ...
        // Decoration negotiation is surface state even though Denial draws
        // the resulting server frame in Flutter.
        bool m_serverSideDecoration = true;

        float effectiveOpacity() const {
            return m_alphaModifier * m_overallOpacity;
        }

        struct {
            CSignalT<> destroy;
            CSignalT<> appearanceChanged;
        } m_events;
