...
// Source embedder.h SHA-256: 41531f8e43ebfbdb867d6eb6e42f1aac8b1605a206fb561f47dfee49faa431e7
...
pub struct DenialFlutterRenderOutput {
    ...
    pub scale_120: u32,
    pub source_to_target_transform: FlutterTransformation,
}
pub type DenialFlutterExternalTextureGlStateCallback = ::std::option::Option<
    unsafe extern "C" fn(user_data: *mut ::std::os::raw::c_void, texture_identifier: i64) -> bool,
>;
unsafe extern "C" {
