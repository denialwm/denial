...
impl AuthenticationController {
    ...
    fn with_backend(mut backend: Box<dyn AuthenticationBackend>) -> io::Result<Self> {
        ...
        let shared = Arc::new(SharedAuthentication {
            ...
            security_gate_locked: AtomicBool::new(false),
...
mod tests {
    ...
    fn successful_current_conversation_unlocks_exactly_once() {
        ...
        let controller = AuthenticationController::with_backend(Box::new(FakeBackend {
